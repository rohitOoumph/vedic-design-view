...
import { useSettings, useNavLinks } from '@/cms/hooks/useContent';
...
const Footer = () => {
  ...
  const address = settings?.address || '#102, MEENAKSHI ENCLAVE, PHASE-I\nKPHB, HYDERABAD';
  const email = settings?.email || 'info@vedicinteriors.com';
  const phone = settings?.phone || '+91 XXXXX XXXXX';
      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-primary-foreground/70">
              Multidisciplinary design firm specializing in residential and corporate interiors.
            </p>
          </div>
        ...
        <div className="border-t border-primary-foreground/20 pt-8">
          <p className="text-xs text-primary-foreground/60 text-center leading-relaxed">
            © {new Date().getFullYear()} {brandName}. All rights reserved. | All design concepts and visuals are proprietary to {brandName}. Unauthorized use or reproduction is prohibited.
          </p>
        </div>
      </div>
    </footer>
