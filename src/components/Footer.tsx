      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                href="https://facebook.com/vedicinteriors" 
                target="_blank"
              ...
              <a 
                href="https://instagram.com/vedicinteriors" 
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-primary-foreground/10 hover:bg-accent rounded-full flex items-center justify-center transition-colors"
              ...
              <a 
                href="https://linkedin.com/company/vedicinteriors" 
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-primary-foreground/10 hover:bg-accent rounded-full flex items-center justify-center transition-colors"
                aria-label="LinkedIn"
        ...
        <div className="border-t border-primary-foreground/20 pt-8">
          <p className="text-xs text-primary-foreground/60 text-center leading-relaxed">
            © 2025 Vedic Architects & Interiors. All rights reserved. | All design concepts and visuals are proprietary to Vedic Architects & Interiors. Unauthorized use or reproduction is prohibited.
          </p>
        </div>
      </div>
    </footer>
